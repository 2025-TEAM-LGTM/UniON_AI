...
ALTER TABLE "users" ADD FOREIGN KEY ("image_id") REFERENCES "image" ("image_id");
...
ALTER TABLE "user_skill" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");

ALTER TABLE "user_skill" ADD FOREIGN KEY ("skill_id") REFERENCES "skill" ("skill_id");

ALTER TABLE "post" ADD FOREIGN KEY ("leader_id") REFERENCES "users" ("user_id");
...
ALTER TABLE "post_info" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("post_id");

ALTER TABLE "post_info" ADD FOREIGN KEY ("image_id") REFERENCES "image" ("image_id");

ALTER TABLE "post_current_role" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("post_id");

ALTER TABLE "post_current_role" ADD FOREIGN KEY ("role_id") REFERENCES "role" ("role_id");

ALTER TABLE "post_recruit_role" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("post_id");

ALTER TABLE "post_recruit_role" ADD FOREIGN KEY ("role_id") REFERENCES "role" ("role_id");

ALTER TABLE "post_vector" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("post_id");

ALTER TABLE "post_apply" ADD FOREIGN KEY ("post_id") REFERENCES "post" ("post_id");

ALTER TABLE "post_apply" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");

ALTER TABLE "portfolio" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");
...
ALTER TABLE "portfolio" ADD FOREIGN KEY ("image_id") REFERENCES "image" ("image_id");

ALTER TABLE "portfolio_vector" ADD FOREIGN KEY ("portfolio_id") REFERENCES "portfolio" ("portfolio_id");
